import {DifficultLevels, irregularLine} from "./types";

export const irregular: { [key: string]: irregularLine } = {
    abide: {
        second: ['abode', 'abided'],
        third: ['abode', 'abided'],
        translation: ['терпіти', 'дотримуватися чогось', 'бути вірним'],
        level: DifficultLevels.UpperIntermediate
    },
    arise: {
        second: ['arose'],
        third: ['arisen'],
    ...
    arrange: {
        ...
        level: DifficultLevels.Intermediate
    },
    awake: {
        second: ['awaked', 'awoke'],
        third: ['awaked', 'awoken'],
    ...
    become: {
        ...
        level: DifficultLevels.PreIntermediate
    },
    befall: {
        second: ['befell'],
        third: ['befallen'],
    ...
    cleave: {
        second: ['cleft', 'cleaved', 'clove'],
        third: ['cleft', 'cleaved', 'cloven'],
    ...
    misspeak: {
        second: ['misspoke'],
        third: ['misspoken'],
        translation: ['вимовляти неправильно'],
        level: DifficultLevels.UpperIntermediate
    },
    misspell: {
    ...
    spell: {
        ...
        third: ['spelled', 'spelt'],
        translation: ['замовляти', 'зачаровувати', 'змінити', 'дати відпочинок', 'писати', 'вимовляти словопо буквах'],
        level: DifficultLevels.Intermediate
    },
    spend: {
        second: ['spent'],
    ...
    wrap: {
        second: ['wrapt', 'wrapped'],
        third: ['wrapt', 'wrapped'],
        translation: ['загорнути'],
        level: DifficultLevels.Intermediate
    },
    wring: {
        second: ['wrung'],
